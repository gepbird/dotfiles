...
static const char* voltoggle[]           = { "chvolume", "set-sink-mute", "0", "toggle", NULL };
static const char* voldown[]             = { "chvolume", "set-sink-volume", "0", "-10%", NULL };
static const char* voldown_little[]      = { "chvolume", "set-sink-volume", "0", "-1%", NULL };
static const char* volup[]               = { "chvolume", "set-sink-volume", "0", "+10%", NULL };
static const char* volup_little[]        = { "chvolume", "set-sink-volume", "0", "+1%", NULL };
static const char* brightdown[]          = { "chbacklight", "-10", NULL };
static const char* brightdown_little[]   = { "chbacklight", "-1", NULL };
static const char* brightup[]            = { "chbacklight", "+10", NULL };
static const char* brightup_little[]     = { "chbacklight", "+1", NULL };
