...
static const char* voltoggle[]        = { "chvolume.sh", "set-sink-mute", "0", "toggle", NULL };
static const char* voldown[]          = { "chvolume.sh", "set-sink-volume", "0", "-10%", NULL };
static const char* voldownlite[]      = { "chvolume.sh", "set-sink-volume", "0", "-1%", NULL };
static const char* volup[]            = { "chvolume.sh", "set-sink-volume", "0", "+10%", NULL };
static const char* voluplite[]        = { "chvolume.sh", "set-sink-volume", "0", "+1%", NULL };
static const char* brightdown[]       = { "chbright.sh", "0.9", NULL };
static const char* brightdownlite[]   = { "chbright.sh", "0.99", NULL };
static const char* brightup[]         = { "chbright.sh", "1.1", NULL };
static const char* brightuplite[]     = { "chbright.sh", "1.01", NULL };
